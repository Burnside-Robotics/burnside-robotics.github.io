...
import SponsorsHeader from "./Assets/Sponsor Header.svg";
function Home() {
	return (
		<div className="App">
			<Header />
			...
			<div className="circuit-background">
				<div className="circuit-background-blur">
					<section id="AboutSection">
						<InfoBox
							content={[
								"Burnside Robotics Club is a team of students attending Burnside High School that love to build robots. We have competed in multiple national Vex Robotics competitions and have qualified for the world competition. Our members are enthusiastic in the areas of STEM (Science, Technology, Engineering, and Maths) and enjoy competing with their creations.",
								"Burnside robotics offers a range of vital skills such as engineering, programming, teamwork, task management, and much more. These skills help students understand the world around them and help them build up skills in a safe, fun environment. ",
							]}
							titles={["ABOUT US", "WHAT WE OFFER"]}
						/>
					...
					<section style={{ paddingTop: "3%" }} id="AwardsSection">
						<Award
							src={FinalistAward}
							side={0}
							name="Tournament Finalists 2020"
						/>
						<Award
							src={DesignAward}
							side={1}
							name="Design Award 2021 "
						/>
						<Award
							src={CommunityAward}
							side={2}
							name="Community Award 2019 "
						/>
					</section>
					...
					<SectionBanner src={SponsorsHeader} />
					<section id="SponsorsSection">
						<InfoBox
							content={[
								"Building robots is expensive. As the number of students interested grow, and robot parts wear away, we need funding for more, but with help from our sponsors we can continue to do what we do best. We would like to give a special thanks to the Tait Foundation for being out best ongoing sponsor.  If you would be interested in becoming a sponsor, please email or phone the contact details at the bottom of this page. Sponsorship can include, logos on team clothing, robots, and on banners.",
							]}
							titles={["TAIT COMMUNICATIONS"]}
							image={TaitLogo}
						/>
					</section>
					<section id="Footer">
						<div>
							<h3>Burnside Robotics</h3>
							<h5 style={{ textAlign: "left", marginTop: "-5%" }}>
								Developed and Maintained by Joran Le Quellec and
								Alex Cutforth
							</h5>
						</div>
						<div>
							<h4>CONTACT US</h4>
							<h5>Email: dnk@burnside.school.nz</h5>
						</div>
					</section>
				</div>
			</div>
