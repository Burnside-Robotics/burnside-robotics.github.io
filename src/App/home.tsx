        ...
        <div className="circuit-background">
            <div className="circuit-background-blur">
                ...
                <section id="SponsorsSection">
                    <InfoBox content={["Building robots is expensive. As the number of students interested grow, and robot parts wear away, we need funding for more, but with help from our sponsors we can continue to do what we do best. We would like to give a special thanks to the Tait Foundation for being out best ongoing sponsor.  If you would be interested in becoming a sponsor, please email or phone the contact details at the bottom of this page. Sponsorship can include, logos on team clothing, robots, and on banners."]} titles={["TAIT COMMUNICATIONS"]} image={TaitLogo}/>
                </section>
                <section id="Footer">
                    <div>
                        <h3>Burnside Robotics</h3>
                        <h5 style={{textAlign: "left", marginTop: "-5%"}}>Developed and Maintained by Joran Le Quellec and Alex Cutforth</h5>
                    </div>
                    <div>
                        <h4>CONTACT US</h4>
