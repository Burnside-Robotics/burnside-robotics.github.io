...
export const Header = () =>
{
    return(
        <header>
            ...
            <a href="#AwardsSection" className="HeaderLink" style={{gridColumn: 6}}>Awards</a>
            <a href="#VexSection" className="HeaderLink" style={{gridColumn: 7}}>Vex</a>
            <a href="#RobotsSection" className="HeaderLink" style={{gridColumn: 8}}>Robots</a>
            <a href="#SponsorsSection" className="HeaderLink" style={{gridColumn: 9}}>Sponsors</a>
